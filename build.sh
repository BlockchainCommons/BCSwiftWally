...
BCWALLY_ROOT=${PROJ_ROOT}/BCWally
...
(
  ...
  build_swift_framework BCWally "secp256k1 wallycore" ${ARM_IOS[@]}
  build_swift_framework BCWally "secp256k1 wallycore" ${X86_CATALYST[@]}
  build_swift_framework BCWally "secp256k1 wallycore" ${ARM_CATALYST[@]}
  build_swift_framework BCWally "secp256k1 wallycore" ${X86_IOS_SIM[@]}
  build_swift_framework BCWally "secp256k1 wallycore" ${ARM_IOS_SIM[@]}
  build_swift_framework BCWally "secp256k1 wallycore" ${X86_MAC[@]}
  build_swift_framework BCWally "secp256k1 wallycore" ${ARM_MAC[@]}
)
...
(
  ...
  build_swift_xcframework BCWally
)
